...
const populationFunc = (countries) => {
   // countries = filterArray(insertedText, countries)
    
    dataDiv.innerHTML = ''
    document.querySelector('.buttonsdiv p').innerHTML = ''
    document.querySelector('.buttonsdiv p').innerHTML = 'Most populated countries in this search'
    ...
    let totalpop = totalPopulation

    let iterate = countries.length > 10 ? 10 : countries.length
    for (let index = 0; index < iterate; index++) {
        ...
        if (index == 0) {
            ...
            c.innerHTML = countries.length >= 250 ? 'World' : 'Total poupulation on this search '
...
document.querySelector('.languages').addEventListener('click', () => languagesFunc(sortedCountries))
    

const languagesFunc = (countries) => {
  
    dataDiv.innerHTML = ''
    document.querySelector('.buttonsdiv p').innerHTML = ''
    document.querySelector('.buttonsdiv p').innerHTML = 'Most spoken languages in this search'
